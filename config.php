...
define("APP_ID", "2da377dd66d0b4c320ce368df1dde0aa");
...
define("META_AUTHOR", "Dermawan Group");
...
define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['id_userlogin'] : null ));
